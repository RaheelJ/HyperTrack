...
void linkages( adouble* linkages, adouble* xad, Workspace* workspace)
{
	...
	for (state=0; state<8; state=state+1)
	{
		...
		linkages[offset++]=xf(3,state)-xi(4,state);
		switch (state)
		{
			case 4:
...
/*************************************************************************************************************************************************/	
	...
	problem.phases(3).nodes = (RowVectorXi(5) << 8, 10, 14, 16, 18).finished();
	
	problem.phases(4).nstates=9;
	problem.phases(4).ncontrols=2;
	problem.phases(4).nevents=1;
	problem.phases(4).npath=1;
	problem.phases(4).nodes = (RowVectorXi(5) << 4, 5, 6, 7, 8).finished();
	
	problem.phases(5).nstates=8;
	problem.phases(5).ncontrols=2;
	problem.phases(5).nevents=4;
	problem.phases(5).npath=0;
	problem.phases(5).nodes = (RowVectorXi(5) << 8, 10, 14, 16, 18).finished();
...
/*************************************************************************************************************************************************/
	...
	double t_fair=159.1;										//Fairing separation time
...
/*************************************************************************************************************************************************/	
	...
	problem.phases(1).bounds.upper.states << alt_max, lon_max, lat_max, speed_max, ee_max, ee_max, ee_max, nn_max, deg_to_rad(Param.alpha_max[0]), m_max;
	...
	problem.phases(2).bounds.upper.states << alt_max, lon_max, lat_max, speed_max, path_ang_max, head_ang_max, deg_to_rad(Param.alpha_max[1]), bank_ang_max, m_s2;
	...
	problem.phases(3).bounds.upper.states << alt_max, lon_max, lat_max, speed_max, path_ang_max, head_ang_max, deg_to_rad(Param.alpha_max[2]), bank_ang_max, m_s3;
	...
	problem.phases(4).bounds.lower.states << alt_min, lon_min, lat_min, speed_min, path_ang_min, head_ang_min, -deg_to_rad(Param.alpha_max[3]), bank_ang_min, m_min;
	...
	problem.phases(5).bounds.lower.states << alt_min, lon_min, lat_min, speed_min, path_ang_min, head_ang_min, -deg_to_rad(Param.alpha_max[4]), bank_ang_min;
	problem.phases(5).bounds.upper.states << alt_max, lon_max, lat_max, speed_max, path_ang_max, head_ang_max, deg_to_rad(Param.alpha_max[4]), bank_ang_max;
	
	problem.phases(5).bounds.lower.controls(0) = -1*deg_to_rad(Param.u_alpha_max[4]);
	problem.phases(5).bounds.upper.controls(0) = deg_to_rad(Param.u_alpha_max[4]);
	problem.phases(5).bounds.lower.controls(1) = -1*deg_to_rad(Param.u_bank_max[4]);
	problem.phases(5).bounds.upper.controls(1) = deg_to_rad(Param.u_bank_max[4]);
	...
	problem.phases(5).bounds.upper.EndTime = 1000;
...
/*************************************************************************************************************************************************/
	...
	problem.phases(4).bounds.upper.path << h_peak_max;
	problem.phases(4).bounds.lower.path << h_atm;
	...
	problem.phases(5).bounds.lower.events << h_peak_min, 0, 0, 0;
	problem.phases(5).bounds.upper.events << h_peak_max, 0, 0, 0;
...
/*************************************************************************************************************************************************/	
	...
	problem.phases(5).guess.states=zeros(9,5);
	problem.phases(5).guess.states.row(0)=linspace(h_peak_max, h_peak_max, 5);
	problem.phases(5).guess.states.row(1)=linspace(deg_to_rad(lon0), deg_to_rad(lon0), 5);
	problem.phases(5).guess.states.row(2)=linspace(deg_to_rad(lat0), deg_to_rad(lat0), 5);
	problem.phases(5).guess.states.row(3)=linspace(speed_max, speed_max, 5);
	problem.phases(5).guess.states.row(4)=linspace(0, 0, 5);
	problem.phases(5).guess.states.row(5)=linspace(0, 0, 5);
	problem.phases(5).guess.states.row(6)=linspace(deg_to_rad(alpha0), deg_to_rad(alpha0), 5);
	problem.phases(5).guess.states.row(7)=linspace(0, 0, 5);
	problem.phases(5).guess.states.row(8)=linspace(m_s4, mdot, 5);

	problem.phases(5).guess.controls = zeros(2,5);
	problem.phases(5).guess.controls.row(0) = -0.1*ones(1, 5);
	problem.phases(5).guess.controls.row(1) = -0.1*ones(1, 5);

	problem.phases(5).guess.time = linspace(t_s3,500, 5);
...
/*************************************************************************************************************************************************/	
	...
	x.resize(10, x_ph1.cols()+x_ph2.cols()+x_ph3.cols()+x_ph4.cols()+x_ph5.cols());
	x.row(0) << x_ph1.row(0), x_ph2.row(0), x_ph3.row(0), x_ph4.row(0), x_ph5.row(0);
	x.row(1) << x_ph1.row(1), x_ph2.row(1), x_ph3.row(1), x_ph4.row(1), x_ph5.row(1);
	x.row(2) << x_ph1.row(2), x_ph2.row(2), x_ph3.row(2), x_ph4.row(2), x_ph5.row(2);
	x.row(3) << x_ph1.row(3), x_ph2.row(3), x_ph3.row(3), x_ph4.row(3), x_ph5.row(3);
	...
	x.row(4) << conv1, x_ph2.row(4), x_ph3.row(4), x_ph4.row(4), x_ph5.row(4);
	x.row(5) << conv2, x_ph2.row(5), x_ph3.row(5), x_ph4.row(5), x_ph5.row(5);
	x.row(6) << x_ph1.row(8), x_ph2.row(6), x_ph3.row(6), x_ph4.row(6), x_ph5.row(6);
	x.row(7) << conv3, x_ph2.row(7), x_ph3.row(7), x_ph4.row(7), x_ph5.row(7);
	
	t.resize(1, t_ph1.cols()+t_ph2.cols()+t_ph3.cols()+t_ph4.cols()+t_ph5.cols());
	t << t_ph1, t_ph2, t_ph3, t_ph4, t_ph5;
...
/*************************************************************************************************************************************************/	
	...
	altitude = x.block(0,0,1,x_ph1.cols()+x_ph2.cols()+x_ph3.cols()+x_ph4.cols()+x_ph5.cols());
	longitude = x.block(1,0,1,x_ph1.cols()+x_ph2.cols()+x_ph3.cols()+x_ph4.cols()+x_ph5.cols()); 
	latitude = x.block(2,0,1,x_ph1.cols()+x_ph2.cols()+x_ph3.cols()+x_ph4.cols()+x_ph5.cols());
	speed_state = x.block(3,0,1,x_ph1.cols()+x_ph2.cols()+x_ph3.cols()+x_ph4.cols()+x_ph5.cols());
    path_angle = x.block(4,0,1,x_ph1.cols()+x_ph2.cols()+x_ph3.cols()+x_ph4.cols()+x_ph5.cols());
	heading_angle = x.block(5,0,1,x_ph1.cols()+x_ph2.cols()+x_ph3.cols()+x_ph4.cols()+x_ph5.cols());
	attack_angle = x.block(6,0,1,x_ph1.cols()+x_ph2.cols()+x_ph3.cols()+x_ph4.cols()+x_ph5.cols());
	bank_angle = x.block(7,0,1,x_ph1.cols()+x_ph2.cols()+x_ph3.cols()+x_ph4.cols()+x_ph5.cols());
