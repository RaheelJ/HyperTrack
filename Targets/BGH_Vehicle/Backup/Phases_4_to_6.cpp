...
{	
	...
	u_alpha=controls[0];
	u_alpha_max=deg_to_rad(Param.u_alpha_max[3+iphase-1]);
	term2=u_alpha/u_alpha_max;
	
	if (iphase==1)
	{
		alpha=states[6];
		alpha_bar=deg_to_rad(Param.alpha_bar[3+iphase-1]);
		alpha_max=deg_to_rad(Param.alpha_max[3+iphase-1]);
	...
	u_bank=controls[1];
	u_bank_max=deg_to_rad(Param.u_bank_max[3+iphase-1]);	
...
/*************************************************************************************************************************************************/	
	...
	problem2.phases(2).bounds.upper.EndTime = 2000;
	...
	problem2.phases(3).bounds.upper.states << h_peak_max, lon_max, lat_max, 7600, path_ang_max, head_ang_max, deg_to_rad(Param.alpha_max[5]), bank_ang_max;
	...
	problem2.phases(3).bounds.upper.StartTime = 2000;
	problem2.phases(3).bounds.lower.EndTime = t_s3;
	problem2.phases(3).bounds.upper.EndTime = 2000;

	for(i=0; i<18; i++)
	{
		problem2.bounds.lower.linkage(low_offset++)= 0;
		problem2.bounds.upper.linkage(up_offset++)= 0;
	}
	low_offset=0;
	up_offset=0;
...
/*************************************************************************************************************************************************/		
	...
	//Events for Problem2
	problem2.phases(1).bounds.lower.events << 80383.9, -2.03055, 0.653264, 5500.02, 0.0989809, 0.908038, 0.00280964, 0.054377, m_s4;
	problem2.phases(1).bounds.upper.events << 80383.9, -2.03055, 0.653264, 5500.02, 0.0989809, 0.908038, 0.00280964, 0.054377, m_s4;
...
/*************************************************************************************************************************************************/		
	...
	problem2.phases(1).guess.states.row(0)=linspace(80383.9, 80383.9, 5);
	problem2.phases(1).guess.states.row(1)=linspace(-2.03055, -2.03055, 5);
	problem2.phases(1).guess.states.row(2)=linspace(0.653264, 0.653264, 5);
	problem2.phases(1).guess.states.row(3)=linspace(5500.02, 5500.02, 5);
	problem2.phases(1).guess.states.row(4)=linspace(0.0989809, 0.0989809, 5);
	problem2.phases(1).guess.states.row(5)=linspace(0.908038, 0.908038, 5);
	problem2.phases(1).guess.states.row(6)=linspace(0.00280964, 0.00280964, 5);
	problem2.phases(1).guess.states.row(7)=linspace(0.054377, 0.054377, 5);
	...
	problem2.phases(1).guess.controls.row(1) = -0.10*ones(1, 5);
	problem2.phases(1).guess.time = linspace(t_fair,t_s3, 5);
	
	//Initial Guess Phase 5
	problem2.phases(2).guess.states=zeros(10,5);
	problem2.phases(2).guess.states.row(0)=linspace(h_peak_max, h_peak_max, 5);
	problem2.phases(2).guess.states.row(1)=linspace(-2.03055, -2.03055, 5);
	problem2.phases(2).guess.states.row(2)=linspace(0.653264, 0.653264, 5);
	problem2.phases(2).guess.states.row(3)=linspace(5500.02, 5500.02, 5);
	problem2.phases(2).guess.states.row(4)=linspace(0, 0, 5);
	problem2.phases(2).guess.states.row(5)=linspace(0.908038, 0.908038, 5);
	...
	problem2.phases(2).guess.controls.row(1) = -0.10*ones(1, 5);
	problem2.phases(2).guess.time = linspace(t_s3,800, 5);
	
	//Initial Guess Phase 6
	problem2.phases(3).guess.states=zeros(10,5);
	problem2.phases(3).guess.states.row(0)=linspace(h_atm, h_atm, 5);
	problem2.phases(3).guess.states.row(1)=linspace(-2.03055, -2.03055, 5);
	problem2.phases(3).guess.states.row(2)=linspace(0.653264, 0.653264, 5);
	problem2.phases(3).guess.states.row(3)=linspace(5500.02, 5500.02, 5);
	problem2.phases(3).guess.states.row(4)=linspace(0, 0, 5);
	problem2.phases(3).guess.states.row(5)=linspace(0.908038, 0.908038, 5);
	...
	problem2.phases(3).guess.controls.row(1) = 0.10*ones(1, 5);
...
/*************************************************************************************************************************************************/		
	...
	x.resize(10, x_ph4.cols()+x_ph5.cols()+x_ph6.cols());
	x_mass.resize(1, x_ph4.cols());
	x.row(0) << x_ph4.row(0), x_ph5.row(0), x_ph6.row(0);
	x.row(1) << x_ph4.row(1), x_ph5.row(1), x_ph6.row(1);
	x.row(2) << x_ph4.row(2), x_ph5.row(2), x_ph6.row(2);
	x.row(3) << x_ph4.row(3), x_ph5.row(3), x_ph6.row(3);	
	x.row(4) << x_ph4.row(4), x_ph5.row(4), x_ph6.row(4);
	x.row(5) << x_ph4.row(5), x_ph5.row(5), x_ph6.row(5);
	x.row(6) << x_ph4.row(6), x_ph5.row(6), x_ph6.row(6);
	x.row(7) << x_ph4.row(7), x_ph5.row(7), x_ph6.row(7);
	x_mass << x_ph4.row(8);
	
	t.resize(1, t_ph4.cols()+t_ph5.cols()+t_ph6.cols());
	t << t_ph4, t_ph5, t_ph6;
	t_mass.resize(1, t_ph4.cols());
	t_mass << t_ph4;
...
/*************************************************************************************************************************************************/	
	...
	altitude = x.block(0,0,1,x_ph4.cols()+x_ph5.cols()+x_ph6.cols());
	longitude = x.block(1,0,1,x_ph4.cols()+x_ph5.cols()+x_ph6.cols()); 
	latitude = x.block(2,0,1,x_ph4.cols()+x_ph5.cols()+x_ph6.cols());
	speed_state = x.block(3,0,1,x_ph4.cols()+x_ph5.cols()+x_ph6.cols());
    path_angle = x.block(4,0,1,x_ph4.cols()+x_ph5.cols()+x_ph6.cols());
	heading_angle = x.block(5,0,1,x_ph4.cols()+x_ph5.cols()+x_ph6.cols());
	attack_angle = x.block(6,0,1,x_ph4.cols()+x_ph5.cols()+x_ph6.cols());
	bank_angle = x.block(7,0,1,x_ph4.cols()+x_ph5.cols()+x_ph6.cols());
