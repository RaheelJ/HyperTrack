...
{	
	...
	//spline_interpolation( &c, h, table_h, table_c_h, Param.n_h);
	mach=V/1125;
	...
	spline_interpolation( &C_L_a, mach, table_mach, table_C_L_a, Param.n_mach);
	spline_interpolation( &C_L_a0, mach, table_mach, table_C_L_a0, Param.n_mach);
	C_L=C_L_a0+C_L_a*alpha_deg;
	L=C_L*q*Param.A_ref;
	...
	spline_interpolation( &C_D0, mach, table_mach, table_C_D0, Param.n_mach);
	spline_interpolation( &C_L0, mach, table_mach, table_C_L0, Param.n_mach);
	spline_interpolation( &C_kk, mach, table_mach, table_C_kk, Param.n_mach);
	...
	spline_2d_interpolation(&CAR, alpha_deg, mach, table_alpha, table_mach, table_CAR, workspace);
	...
	spline_2d_interpolation(&I_sp, throttle, mach, table_throttle, table_mach, table_I_sp, workspace);
