...
/*************************************************************************************************************************************************/	
	...
	problem.phases(1).nodes = (RowVectorXi(5) << 12, 16, 26, 32, 38).finished();
...
/*************************************************************************************************************************************************/	
	...
	problem.phases(3).bounds.upper.states << h_atm, lon_max, lat_max, speed_max, path_ang_max, head_ang_max, deg_to_rad(Param.alpha_max[2]), bank_ang_max, m_s3;
...
/*************************************************************************************************************************************************/
	...
	problem.phases(3).bounds.lower.events << m_s3, h_atm;
	problem.phases(3).bounds.upper.events << m_s3, h_atm;
...
/*************************************************************************************************************************************************/	
	...
	problem.phases(1).guess.parameters(0) = 1e-5;
	problem.phases(1).guess.parameters(1) = 1e-5;
...
/*************************************************************************************************************************************************/	
	...
	x.row(4) << conv1, x_ph2.row(4), x_ph3.row(4);
	x.row(5) << conv2, x_ph2.row(5), x_ph3.row(5);
	x.row(6) << x_ph1.row(8), x_ph2.row(6), x_ph3.row(6);
	x.row(7) << conv3, x_ph2.row(7), x_ph3.row(7);
	x.row(8) << x_ph1.row(9), x_ph2.row(8), x_ph3.row(8);
...
/*************************************************************************************************************************************************/	
	...
	attack_angle = x.block(6,0,1,x_ph1.cols()+x_ph2.cols()+x_ph3.cols());
	bank_angle = x.block(7,0,1,x_ph1.cols()+x_ph2.cols()+x_ph3.cols());
	mass_state = x.block(8,0,1,x_ph1.cols()+x_ph2.cols()+x_ph3.cols());
	...
	plot(t,mass_state,problem.name, "time (s)", "Mass (kg)");
