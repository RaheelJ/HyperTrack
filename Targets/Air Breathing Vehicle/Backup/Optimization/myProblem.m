...
% State error bounds
problem.states.xErrorTol_local      = [2 deg2rad(2e-4) deg2rad(2e-4) 2 deg2rad(0.8) deg2rad(0.8) 2]; 
problem.states.xErrorTol_integral   = [2 deg2rad(2e-4) deg2rad(2e-4) 2 deg2rad(0.8) deg2rad(0.8) 2]; 

% State constraint error bounds
problem.states.xConstraintTol       = [2 deg2rad(2e-4) deg2rad(2e-4) 2 deg2rad(0.8) deg2rad(0.8) 2]; 
problem.states.xrConstraintTol      = [2 deg2rad(2e-4) deg2rad(2e-4) 2 deg2rad(0.8) deg2rad(0.8) 2]; 
...
% Input rate bounds
problem.inputs.url = [u_alpha_min u_bank_min -u_mf_max/10]; 
problem.inputs.uru = [u_alpha_max u_bank_max  u_mf_max/10]; 
...
problem.constraints.gTol_neq    = [10 0.1 deg2rad(2e-4)*ones(1, 10)]; % inequality constraint error bounds
